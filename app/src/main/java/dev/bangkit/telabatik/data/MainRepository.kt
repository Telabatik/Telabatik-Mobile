package dev.bangkit.telabatik.data

import androidx.lifecycle.liveData
import dev.bangkit.telabatik.data.api.ApiService
import dev.bangkit.telabatik.data.api.BatikInfo
import dev.bangkit.telabatik.data.api.LoginResponse
import dev.bangkit.telabatik.data.api.LoginResult
import dev.bangkit.telabatik.data.api.PredictResponse
import dev.bangkit.telabatik.data.api.StatusResponse
...
class MainRepository private constructor(
    ...
    fun getPredictionHistory() = liveData {
        ...
        try {
            ...
            val sortedResponse = successResponse.data.sortedByDescending { it.predictedAt }
            emit(ResultState.Success(sortedResponse))
        } catch (e: Exception) {
            emit(handleApiException(e))
        }
    }
    ...
    val mockBatikInfoList = listOf(
        ...
        BatikInfo(name = "Batik Kawung", image = "https://raw.githubusercontent.com/Telabatik/Machine-Learning/refs/heads/main/Dataset/train/Batik%20Kawung/0016.jpg"),
