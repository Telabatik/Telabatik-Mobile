package dev.bangkit.telabatik.view.components
...
class HorizontalReferenceItem @JvmOverloads constructor(
    context: Context,
    ...
    init {
        LayoutInflater.from(context).inflate(R.layout.item_referensi_horz, this, true)

        titleTextView = findViewById(R.id.tv_item_horz_title)
        descriptionTextView = findViewById(R.id.tv_item_horz_description)
        imageView = findViewById(R.id.iv_item_horz_img)
